...
CREATE TABLE "new_debates" (
    ...
    "appeal_reason" TEXT,
    "appealed_statements" TEXT,
    "appeal_rejection_reason" TEXT,
...
INSERT INTO "new_debates" ("appeal_count", "appeal_reason", "appeal_rejection_reason", "appeal_status", "appealed_at", "appealed_by", "appealed_statements", "category", "challenger_elo_change", "challenger_id", "challenger_position", "created_at", "current_round", "description", "ended_at", "featured", "id", "opponent_elo_change", "opponent_id", "opponent_position", "original_winner_id", "round_deadline", "round_duration", "spectator_count", "speed_mode", "started_at", "status", "topic", "total_rounds", "updated_at", "verdict_date", "verdict_reached", "winner_id") SELECT "appeal_count", "appeal_reason", "appeal_rejection_reason", "appeal_status", "appealed_at", "appealed_by", "appealed_statements", "category", "challenger_elo_change", "challenger_id", "challenger_position", "created_at", "current_round", "description", "ended_at", "featured", "id", "opponent_elo_change", "opponent_id", "opponent_position", "original_winner_id", "round_deadline", "round_duration", "spectator_count", "speed_mode", "started_at", "status", "topic", "total_rounds", "updated_at", "verdict_date", "verdict_reached", "winner_id" FROM "debates";
DROP TABLE "debates";
